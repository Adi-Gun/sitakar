		...
		<div class="box-body">
			<div class="table-responsive">
				<table id="example1" class="table table-bordered table-striped">
                  ...
                  $no = 1;
				  $sql = $koneksi->query("select k.id_karyawan, k.nama_karyawan, t.id_tabungan, t.setor, t.tgl, t.petugas from 
				  tb_karyawan k inner join tb_tabungan t on k.id_karyawan=t.id_karyawan
